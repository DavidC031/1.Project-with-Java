...
public class felix extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(salir, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 10, 60, -1));
        ...
        getContentPane().add(user, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 270, -1, 50));

        contraseña.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        contraseña.setForeground(new java.awt.Color(255, 255, 255));
        contraseña.setText("Password :");
        getContentPane().add(contraseña, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 320, -1, 40));
        ...
        getContentPane().add(jPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 330, 140, 20));
        ...
        getContentPane().add(jTextFielduser, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 280, 140, 20));
        ...
        getContentPane().add(iniciar, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 370, 140, 30));
        ...
        getContentPane().add(registro, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 370, 100, 30));
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 280, 440));
